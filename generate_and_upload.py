...
# -----------------------------
# Step 1: Generate AI Biography
# -----------------------------
print("📝 Generating AI biography in Hindi...")
openai.api_key = os.environ["OPENAI_API_KEY"]

prompt = (
    "Write a concise, engaging 1-minute biography of Mahatma Gandhi in Hindi suitable for a YouTube Short. "
    "Make it natural, easy to understand, and suitable for narration."
)
